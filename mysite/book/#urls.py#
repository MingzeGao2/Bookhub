...
urlpatterns = patterns('',
                       ...
                       url(r'^delete_from_need/$',views.delete_from_need, name='delete_from_need'),
                       url(r'^delete_from_have/$', views.delete_from_have, name='delete_from_have'),
                       url(r'^needbook/$', views.needbook, name='needbook'),
                       url(r'^search/$', views.search, name='search'),
                       url(r'^havebook/$', views.havebook, name='havebook'),
